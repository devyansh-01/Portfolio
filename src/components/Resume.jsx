...
const TIMELINE = [
  {
    ...
    desc: "Building a strong foundation in computer science and data science while exploring software engineering, analytics, and emerging technologies.",
  },
  {
    type: "PROJECT",
    date: "April 2026 – May 2026",
    title: "Insyte — Smart Dataset Analyzer",
    org: "Data Analysis & Automation",
    desc: "Built an automated dataset analyzer for data cleaning, statistical summaries, visualizations, and insight generation.",
  },
  {
    type: "PROJECT",
    date: "February 2026 – March 2026",
    title: "IPL Data Analysis",
    org: "Data Analysis & Visualization",
    desc: "Analyzed 15+ seasons of IPL data to identify player, team, scoring, and venue-based performance trends.",
  },
];

export default function Resume() {
  return (
    <section id="resume" className="min-h-[calc(100vh-68px)] flex flex-col py-12 sm:py-16 relative">
