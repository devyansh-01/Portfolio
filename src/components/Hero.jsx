        ...
        <div className="text-left order-2 md:order-1">
          ...
          <FadeIn delay={0.3}>
            <p className="text-base sm:text-lg md:text-xl text-[var(--fg-muted)] mb-8 md:mb-10 leading-relaxed font-light">
              Computer Science student specializing in Data Science, building backend systems, data-driven applications, and AI-powered solutions with modern technologies.
            </p>
          </FadeIn>
